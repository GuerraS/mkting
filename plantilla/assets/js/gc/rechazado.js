...
function nodos(){
    ...
    $.ajax({
        type: 'ajax',
        method: 'get',
        url: '../gc/Rechazados_c/mostrarnodosrechazados',
...
function showAllEmployee(){
    ...
    $.ajax({
        type: 'ajax',
        method:'get',
        url: '../gc/Rechazados_c/mostrarpubrechazadas',
        ...
        '</tr>';
            ...
            for(i=0; i<data.length; i++){
                ...
                html +='<tr>'+
                            ...
                            '<td>'+
                                '<a href="javascript:;" class="btn btn-info item-edit" data="'+data[i].id_preautorizacion+'" >Visualizar</a>'+
...
$('#showdata').on('click', '.item-edit', function(){
    ...
    var idpreautorizacion = $(this).attr('data');
    $('#myModal').modal('show');
    ...
    $.ajax({
        type: 'ajax',
        method: 'get',
        url: '../gc/Rechazados_c/form_rechazadas',
        data: {idpreautorizacion: idpreautorizacion},
        async: false,
        dataType: 'json',
        success: function(data){
            var getUrl = window.location;
