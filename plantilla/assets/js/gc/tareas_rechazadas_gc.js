...
function showAllEmployee(){
    ...
    $.ajax({
        type: 'ajax',
        method:'get',
        url: '../gc/Asignar_tareas_c/mostrartareasrechazadas',
        ...
        '</tr>';
            ...
            for(i=0; i<data.length; i++){
                ...
                html +='<tr>'+
                            ...
                            '<td>'+
                                '<a href="javascript:;" class="btn btn-info item-edit" data="'+data[i].id_tarea+'" >Visualizar</a>'+
            ...
            alert('No hay tareas rechazadas ');
            var html = '';
            var html2 = '';
            $('#showhead').html(html2);
            $('#showdata').html(html);
...
function mostrardisenador(){
    $("#mydisenador").attr("required", "false");
}
function mostrardisenador(){
    var idcampana=$('#campana').val();
    var idNodo=$('#nodo').val();
    $("#mydisenador").attr("required", "true");
