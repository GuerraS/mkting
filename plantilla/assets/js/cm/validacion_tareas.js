...
function nodos(){
    ...
    $.ajax({
        type: 'ajax',
        method: 'get',
        url: '../cm/Asignar_tareas_c/mostrarnodos',
...
function selectempleados(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            html2 += " <option value='0' disabled='' selected=''>Selecciona Generador de contenido</option>";
            for(i=0; i<data.length; i++){
            ...
            $('#empleado').html(html2);
                ...
                alert('No hay generador de contenido en este nodo');
