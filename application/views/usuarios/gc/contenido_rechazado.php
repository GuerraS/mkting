                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Rediseñar</h2>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="myForm" action="<?php echo base_url()?>index.php/inicio/preautorizacion_rechazada" method="post" enctype="multipart/form-data" role="form">
      ...
      <input type="hidden" id="id_cm" name="id_cm" value="0">
                ...
                <button type="submit" name="revision" class="btn btn-primary" >Enviar a Revisión</button>
                </div>
                </div>                               
                </form>
      </div>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/gc/rechazado.js"></script>
