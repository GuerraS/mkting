                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Tareas Recibidas de Diseñador</h2>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" id="id_dc" name="id_dc" value="0">
                ...
                <button  type="submit" name="rechazar" id="rechazar"  class="btn btn-danger" >Rechazar</button>
                </div>
                </div>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/gc/tareas_recibidas_de_disenador.js"></script>
