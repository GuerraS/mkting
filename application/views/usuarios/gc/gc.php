      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Contenido aprovado y publicado</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Publicaciones Semanales aprovadas</span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!-- ============================================================== -->
        <!-- end wrapper  --> 
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/gc/dashboardcm.js"></script>
