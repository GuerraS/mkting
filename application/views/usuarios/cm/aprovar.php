                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Revisión </h2>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="myForm" action="<?php echo base_url()?>index.php/inicio/publicar_programar_rechazar" method="post" enctype="multipart/form-data" role="form">
      <input type="hidden" id="id_preautorizacion" name="id_preautorizacion" value="0">
      ...
      <input type="hidden" id="id_gc" name="id_gc" value="0">
                ...
                <input type="date" class="form-control is-valid" id="finicio" name="finicio" required >
                ...
                <input type="time" class="form-control is-valid" id="hinicio" name="hinicio" required value="" >
                ...
                <div class="col-md-12 mb-6"> 
                <button type="submit" name="publicar" class="btn btn-info ">Publicar Ahora</button>
                <button type="submit" name="programar" class="btn btn-success" >Autorizar y  Programar</button>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/cm/aprobar.js"></script>
