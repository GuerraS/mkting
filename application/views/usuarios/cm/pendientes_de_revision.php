                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Pendientes de Revision/Publicar</h2>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" id="id_dc" name="id_dc" value="0">
                ...
                <div class="col-md-12 mb-6"> 
                <button type="submit" name="publicartarea" id="publicartarea" class="btn btn-success ">Publicar</button>
                
                <button  type="submit" name="rechazartarea" id="rechazartarea"  class="btn btn-danger" >Rechazar</button>
                </div>
                </div>                               
                </form>
      </div>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/cm/tareas_pendientes_revision.js"></script>
