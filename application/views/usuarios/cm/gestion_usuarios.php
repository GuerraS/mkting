  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="id" value="0">
                ...
                <option value="4">Diseñador de Contenido</option>
                <option value="5">Generador de Contenido</option>
                </select>
                </div>
                </div>                           
                </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/cm/validaciones_usuario.js"></script>
