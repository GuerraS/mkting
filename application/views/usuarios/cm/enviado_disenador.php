                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Contenido Enviado a Diseñador</h2>
...
<div class="container">
	...
	<table class="table table-striped table-bordered" style="margin-top: 20px;" style="width:100%" id="example">
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/cm/enviado_disenador.js"></script>
