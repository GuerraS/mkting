                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Contenido Recibido</h2>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="myForm" action="<?php echo base_url()?>index.php/inicio/disenador" method="post" enctype="multipart/form-data" role="form">
      ...
      <input type="hidden" id="id_gc" name="id_gc" value="0">
                ...
                <textarea  class="form-control" name="contenido"  id="contenido" required readonly  >
                </textarea>
                ...
                <div class="col-md-12 mb-6"> 
                <button type="submit" name="guardar" class="btn btn-info ">Enviar a Revisión</button>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/dc/contenido_recibido.js"></script>
