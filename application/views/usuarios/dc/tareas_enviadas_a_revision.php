                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Tareas enviadas a Revisión</h2>
...
<table class="table table-striped table-bordered" style="margin-top: 20px;" style="width:100%" id="example">
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/dc/tareas_enviadadas_a_revision.js"></script>
