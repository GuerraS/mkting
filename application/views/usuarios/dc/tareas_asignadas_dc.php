...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="myForm" action="<?php echo base_url()?>index.php/inicio/revision_tarea_dc" method="post" enctype="multipart/form-data" role="form">
      ...
      <input type="hidden" id="id_dc" name="id_dc" value="0">
                ...
                <div class="col-md-12 mb-6"> 
                <button type="submit" name="revision" id="revision" class="btn btn-info ">Enviar a Revisión</button>
        ...
        <script type="text/javascript" src="<?php echo base_url()?>plantilla/assets/js/dc/tareas_asignadas.js"></script>
